...
{
 "use strict";
 var Global,WebSharper,AspNetCore,WebSocket,Async,Obj,WebSocketEndpoint,Client,Message,WebSocketServer,WithEncoding,Control,MailboxProcessor,Concurrency,IntelliFactory,Runtime,JSON,Json,Seq;
 Global=self;
